...
$Aktiv = Invoke-WebRequest http://root3.minerswin.de/aktiv.html -UseBasicParsing
   Write-Output "$(Get-Date) Aktiv: $($Aktiv)"
   if ($Aktiv.Content -eq "Ja"){
   }else{
     [System.Windows.Forms.MessageBox]::Show("Diese Alpha Version wurde gesperrt. Bitte Offizielle Version herunterladen","https://thegeekfreaks.de",1)
     break
   }
